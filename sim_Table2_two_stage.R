...
gen.A2 <- function(X0, A0, X1, Y1, A1, X2, site,
  ...
  prob <- expit(beta2.0 + beta2.1*X0 + beta2.2*X1 + beta2.3*X2 +
                  beta2.4*A0 + beta2.5*A1 + beta2.6*rowMeans(Y1) + beta2.site[site])
...
msm_individual_exch_coef <- msm.site.exch.coef.random[-c(793),]
msm_individual_exch_sd <- msm.site.exch.sd.random[-c(793),]
